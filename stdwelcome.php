            ...
            <div class="stdpage">
                ...
                <div class="top img">
                   ...
                   <!--  <map name="oesnav">
                    ...
                    <button onclick="{location.href='viewresult.php'}" class="subbtn">察看结果</button>
                    <button onclick="{location.href='stdtest.php'}" class="subbtn">参加新测试</button>
                    <button onclick="{location.href='practicetest.php'}" class="subbtn">练习测试</button>
                    <button onclick="{location.href='resumetest.php'}" class="subbtn">恢复测试</button>
                </div>
                <?php }?>
