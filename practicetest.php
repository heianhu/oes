                    ...
                    <div class="tc">
                        ...
                        <table border="0" width="100%" class="ntab">
                            <tr>
                                ...
                                <th style="width:20%;"><h4 style="color: #af0a36;"><input type="checkbox" name="markreview" value="mark"> 标记回看</input></h4></th>
                            </tr>
                        </table>
                            ...
                            <div class="tc">
                                ...
                                <table border="0" width="100%" class="ntab">
                                    <tr>
                                        ...
                                        <th style="width:20%;"><h4 style="color: #af0a36;"><input type="checkbox" name="markreview" value="mark"> 标记复习</input></h4></th>
                                    </tr>
                                </table>
